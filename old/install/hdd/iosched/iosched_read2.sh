...
echo 108000 > /sys/block/sda/queue/iosched/write_expire
echo 108000 > /sys/block/sdb/queue/iosched/write_expire
echo 108000 > /sys/block/sdc/queue/iosched/write_expire
echo 108000 > /sys/block/sdd/queue/iosched/write_expire
echo 108000 > /sys/block/sde/queue/iosched/write_expire

echo 1080 > /sys/block/sda/queue/iosched/fifo_batch
echo 1080 > /sys/block/sdb/queue/iosched/fifo_batch
echo 1080 > /sys/block/sdc/queue/iosched/fifo_batch
echo 1080 > /sys/block/sdd/queue/iosched/fifo_batch
echo 1080 > /sys/block/sde/queue/iosched/fifo_batch
