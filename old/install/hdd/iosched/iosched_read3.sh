...
echo 18 > /sys/block/sda/queue/iosched/read_expire
echo 18 > /sys/block/sdb/queue/iosched/read_expire
echo 18 > /sys/block/sdc/queue/iosched/read_expire
echo 18 > /sys/block/sdd/queue/iosched/read_expire
echo 18 > /sys/block/sde/queue/iosched/read_expire
