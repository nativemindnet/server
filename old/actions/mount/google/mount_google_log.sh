...
nohup nice -n 17 ionice -c3 -n2 env PATH=/tmp/xdg:$PATH google-drive-ocamlfuse -label $GNAME $GPATH -o noatime,nosuid,nodev,nonempty -verbose >> $LOGPATH/mount_google_$GNAME.log 2>&1 & GPID=$!
echo mount ok
#& GPID=$!
