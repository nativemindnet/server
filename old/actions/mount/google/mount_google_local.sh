...
#nohup 
#nice -n 18 ionice -c3 -n2 env PATH=/tmp/xdg:$PATH google-drive-ocamlfuse -label $GNAME $GPATH -o noatime,nosuid,nodev,nonempty -verbose
nice -n 18 ionice -c3 -n2 env PATH=/tmp/xdg:$PATH google-drive-ocamlfuse -label $GNAME $GPATH -o noatime,nosuid,nodev,nonempty -verbose  -debug -m 
# -debug -m 
